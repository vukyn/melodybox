...
- [ESP32 classic pinout](memory/esp32-classic-pinout.md) — WROOM-32; OLED SDA 21/SCL 22; avoid strapping pins
- [melodybox onboarded](memory/melodybox-onboarded.md) — offline ESP32 MP3 (YX6300+OLED); YX6300→VIN 5V; vol 0–30
